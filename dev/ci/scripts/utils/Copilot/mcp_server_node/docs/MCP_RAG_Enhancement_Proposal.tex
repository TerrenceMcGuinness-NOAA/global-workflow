...
\begin{tabular}{|c|c|c|}
\hline
\textcolor{noaaBlue}{\textbf{EE2 Standards}} & \textcolor{noaaBlue}{\textbf{Rocoto Workflows}} & \textcolor{noaaBlue}{\textbf{RDHPCS Docs}} \\
\hline
NWS HPC Standards & XML Definitions & Infrastructure \\
\hline
\multicolumn{3}{|c|}{\textcolor{noaaNavy}{\textbf{RAG Processing Engine}}} \\
\hline
\end{tabular}
}
\end{center}
...
\hline
\textcolor{green}{\textbf{Phase 1}} & \textcolor{orange}{\textbf{Phase 2}} & \textcolor{red}{\textbf{Phase 3}} & \textcolor{blue}{\textbf{Phase 4}} \\
\hline
Foundation & RAG Integration & Security \& Scale & Production \\
\hline
\textcolor{green}{\textbf{COMPLETE}} & Q3 2025 & Q4 2025 & Q1 2026 \\
\hline
\end{tabular}
}
\end{center}
